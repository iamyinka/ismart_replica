...
//        var chatInput       = $('#sidebar-chat-message');
        var chatInput       = $('#sidebarChatForm\\:msgInput');
        var chatMsg         = '';
        ...
        /*$('#chat-talk-close-btn').click(function(){
            console.log("chat-talk-close-btn button click...");
        	chatTalk.slideUp();
            chatUsers.slideDown();
            return false;
        });*/
        ...
        $('#sidebar-chat-form').submit(function(e){
            ...
            console.log('Form submit sidebar-chat-form');
...
$(function() {
	  ...
	  $("body").click(function(e) {
	    ...
	    if (e.target.id == "page-container" || $(e.target).parents("#page-container").length) {
	    	//console.log("Inside div");
	    } else if (e.target.id == "msgIconLink" || $(e.target).parents("#msgIconLink").length) {
	    	//console.log("Inside div - msgIconLink");
	    } else {
	    	if($('.sidebar-alt-visible-lg').length > 0){
	    		$('div').removeClass('sidebar-alt-visible-lg');
	    		$('ul.chat-users').css('display','block');
	    		$('div.chat-talk').css('display','none');
	    	}
	    }

		var componentId = e.target.id;
		var chatUsersMain = $('.chat-users');
		var chatTalkMain = $('.chat-talk');
		if (componentId == 'chat-talk-close-btn') {
			//console.log('Close button Click');
			chatTalkMain.slideUp();
			chatUsersMain.slideDown();
		} else {
			//console.log('Close button is not click');
		}
